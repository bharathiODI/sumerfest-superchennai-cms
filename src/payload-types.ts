...
export interface Config {
  ...
  collections: {
    ...
    'summer-events': SummerEvent;
    venues: Venue;
    'partner-categories': PartnerCategory;
    'event-types': EventType;
    'festival-weeks': FestivalWeek;
  ...
  collectionsSelect: {
    ...
    'summer-events': SummerEventsSelect<false> | SummerEventsSelect<true>;
    ...
    'festival-weeks': FestivalWeeksSelect<false> | FestivalWeeksSelect<true>;
...
export interface Partner {
  ...
  partnerDetails: {
    ...
    website?: string | null;
    partnerCategory?: (number | null) | PartnerCategory;
    description?: string | null;
  };
  meta?: {
    title?: string | null;
...
export interface PartnerCategory {
  id: number;
  /**
   * Example: Food Partner, Movie Partner
   */
  title: string;
  /**
   * Example: food-partner
   */
  slug: string;
  /**
   * Short explanation about this partner category
   */
  description?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "summer-events".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "festival-weeks".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "summer-events_select".
 */
export interface SummerEventsSelect<T extends boolean = true> {
  title?: T;
  heroImage?: T;
  mobileImage?: T;
  content?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "festival-weeks_select".
 */
export interface FestivalWeeksSelect<T extends boolean = true> {
  title?: T;
  slug?: T;
  weekNumber?: T;
  startDate?: T;
